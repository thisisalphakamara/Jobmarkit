  ...
  return (
    <>
      ...
      <div
        ...
        } top-0 left-0 right-0 z-10 w-full transition-all duration-300`}
      >
        <nav
        ...
        >
          ...
          >
            ...
            <span className="text-2xl font-bold text-black">Jobmarkit</span>
          </div>
          ...
          <div className="flex items-center gap-4">
            {user ? (
              <>
                <Link
                  to="/applications"
                  className="hidden md:flex items-center gap-2 text-gray-700 hover:text-indigo-900 transition-all duration-200 px-4 py-2 rounded-lg hover:bg-blue-50"
                >
                  <Briefcase size={18} />
              ...
              <>
                <button
                  ...
                  className="hidden md:block text-sm font-medium text-gray-600 hover:text-black transition-all duration-200 px-4 py-2 rounded-lg hover:bg-blue-50"
                >
                  Recruiter Portal
                </button>
                <button
                  onClick={(e) => openSignIn()}
                  className={`bg-black text-white hover:bg-white hover:text-black px-6 py-2.5 rounded-xl font-medium text-sm ${
                    scrolled
