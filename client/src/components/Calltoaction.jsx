      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="relative text-center">
            ...
            >
              Your Career, Your Future — Simplified with Smart Matching
              Technology
            </motion.p>
            ...
            >
              <motion.button
                ...
                className="flex items-center justify-center px-8 py-4 text-base font-medium text-black transition-all duration-300 bg-white rounded-xl hover:bg-black focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2 shadow-lg hover:shadow-xl hover:text-white hover:border-2 border-white"
              >
